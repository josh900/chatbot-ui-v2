...
AS $$
DECLARE
  project_url TEXT := 'https://gylpeolgazudmutygknm.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imd5bHBlb2xnYXp1ZG11dHlna25tIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNzYxNDM0OCwiZXhwIjoyMDIzMTkwMzQ4fQ.9mI9SoMF0wz8H2k9QpCVaF5lHUjwTk_W0Tlbjf-vjxY'; -- full access needed for http request to storage
